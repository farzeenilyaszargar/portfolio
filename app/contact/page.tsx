      ...
      <div className='h-160 flex justify-center items-center '>
        ...
        <div className=' border border-black bg-white text-black flex flex-col p-5  rounded-2xl justify-center items-center'>
          ...
          <div className='flex flex-row items-center gap-2 mt-2'>
            <Link href="https://www.github.com/farzenilyaszargar" className="hover:scale-120"><Image src={githubIcon} alt='github'></Image></Link>
            <Link href="/" className="hover:scale-120"><Image src={linkedinIcon} alt='linkedin'></Image></Link>
          </div>
        </div>
